...
public class CourseManager {
	...
	public void add(Course course) throws Exception {
		...
		Course[] courses = { new Course(1, "Java", "Java ile Programlama", "Engin Demiroğ", 100),
				new Course(2, "C#", "C# ile Programlama", "Engin Demiroğ", 200),
				new Course(3, "Phyton", "Phyton ile Programlama", "Engin Demiroğ", 300),
				new Course(4, "C++", "C++ ile Programlama", "Engin Demiroğ", 400) };
